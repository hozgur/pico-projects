...
class LCD_1inch3(framebuf.FrameBuffer):
    def __init__(self, bgLight=0.8):
        self.width = 240
        self.height = 240
        
        self.pwm = PWM(Pin(BL))
        self.pwm.freq(1000)
        self.pwm.duty_u16(int(65535 * bgLight))
        ...
        self.red   =   0x07E0 # Bunlar yanlis
        self.green =   0x001f
        self.blue  =   0xf800
        self.white =   0xffff
        
    def set_backlight(self, value):
        """Set backlight value (0.0 to 1.0)"""
        self.pwm.duty_u16(int(65535 * value))
