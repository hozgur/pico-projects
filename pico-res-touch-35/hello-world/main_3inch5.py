...
if __name__=='__main__':
    ...
    #color BRG
    LCD.fill(WHITE)
    LCD.fill_rect(140,5,200,30,RED)
    LCD.text("Raspberry Pi Pico",170,17,WHITE)
    display_color = 0x001F
    LCD.text("3.5' IPS LCD TEST",170,57,BLACK)
    for i in range(0,12):      
    ...
    while True:      
        ...
        if get != None: 
            ...
            if(Y_Point>220):
                LCD.fill(WHITE)
                if(X_Point<120):
                    LCD.fill_rect(0,60,120,100,RED)
                    LCD.text("Button0",20,110,WHITE)
                elif(X_Point<240):
                    LCD.fill_rect(120,60,120,100,RED)
                    LCD.text("Button1",150,110,WHITE)
                elif(X_Point<360):
                    LCD.fill_rect(240,60,120,100,RED)
                    LCD.text("Button2",270,110,WHITE)
                else:
                    LCD.fill_rect(360,60,120,100,RED)
                    LCD.text("Button3",400,110,WHITE)           
        else :
           LCD.fill(WHITE)
           LCD.text("Button0",20,110,BLACK)
           LCD.text("Button1",150,110,BLACK)
           LCD.text("Button2",270,110,BLACK)
           LCD.text("Button3",400,110,BLACK)
